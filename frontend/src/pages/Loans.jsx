...
export default function Loans() {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      setModalOpen(false);
      setFormData({ memberId: '', loanAmount: '', interestRate: '10', loanDate: new Date().toISOString().slice(0, 10), termMonths: '12' });
      loadData();
    } catch (e) {
        ...
        <Table>
          ...
          <TableBody>
            {loading ? (
              ...
              <TableRow>
                <Td colSpan={6} className="text-center py-8 text-gray-500">No loans yet.</Td>
              </TableRow>
            ) : (
              loans.map((loan) => (
